...
public class CustomerTester {
    public static void main(String[] args) {
        ...
        int prevPoints = customer1.getRewardPoints();
        System.out.println("Previous customer1 points: " + prevPoints);
        customer1.boostPoints(50.0);
        System.out.println(
                "7.1 Can I boost a customer's points? " + testBoostPoints(customer1, prevPoints));
        System.out.println("Current customer1 points: " + customer1.getRewardPoints());
    ...
    public static String testBoostPoints(Customer customer1, int rewardPoints) {
        return customer1.getRewardPoints() != rewardPoints ? "... Pass!" : "... Fail!";
    }
}
