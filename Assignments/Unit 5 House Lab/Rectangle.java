...
public class Rectangle extends Shape {
    ...
    public void draw(Graphics g) {
        ...
        g2D.setPaint(fillColor); // sets the paint color to fillColor
        g2D.fillRect(xCoord[0], yCoord[0], length, width); // draws a rectangle (filled in with fillColor)

        g2D.setPaint(strokeColor); // sets the paint color to strokeColor
        g2D.setStroke(new BasicStroke(strokeWidth)); // changes the line stroke width to strokeWidth
