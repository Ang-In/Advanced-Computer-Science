public class NameOpsTester {
    public static void main(String[] args) {
        ...
        // testing printMethodCall()
        System.out.println("== Testing printMethodCall() ==");
        System.out.println("printMethodCall(”indexOfFirstSpace”, “Killua”): "
                + NameOps.printMethodCall("indexOfFirstSpace", "Killua"));
        System.out.println("printMethodCall(”findMiddleName”, “Jon Snow”): "
                + NameOps.printMethodCall("findMiddleName", "Jon Snow"));
        System.out.println();
