public class Unit2ExercisesTester {
    public static void main(String[] args) {
        ...
        int[] sArr01 = {1, 2, 2, 1};
        int[] sArr02 = {1, 1};
        int[] sArr03 = {1, 2, 2, 1, 13};
        int[] sArrEmpty = new int[0];
        System.out.println("== Testing sum13() ==");
        System.out
                .println(Utils.testerLabel("sum13", "[1, 2, 2, 1]") + Unit2Exercises.sum13(sArr01));
        System.out.println(Utils.testerLabel("sum13", "[1, 1]") + Unit2Exercises.sum13(sArr02));
        System.out.println(
                Utils.testerLabel("sum13", "[1, 2, 2, 1, 13]") + Unit2Exercises.sum13(sArr03));
        System.out.println(Utils.testerLabel("sum13", "[]") + Unit2Exercises.sum13(sArrEmpty));
        // should be 0
        System.out.println("");
